...
Original file is located at
    https://colab.research.google.com/drive/1Iz2b4Nx9jPetW5Rgc4NY4X6mIbMeWYya
"""
...
def imports():
    movies = pd.read_csv('file:///Users/timothee/Desktop/ml-latest-small/movies.csv')
    movies["title2"]=movies.title.apply(lambda x:x.lower())
    ratings = pd.read_csv('file:///Users/timothee/Desktop/ml-latest-small/ratings.csv')
    corrMatrix = pd.read_csv('file:///Users/timothee/Desktop/matrice2.csv')
    ...
    links = pd.read_csv('file:///Users/timothee/Desktop/image.csv')
...
try :
    ...
    ("Raiders of the Lost Ark (Indiana Jones and the Raiders of the Lost Ark)",int(st.sidebar.slider("Indiana Jones (Pas Robert Redford)",0, 5)))]
